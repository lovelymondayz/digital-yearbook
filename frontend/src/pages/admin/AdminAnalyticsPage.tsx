    ...
    <div className=min-h-screen py-12 px-4>
      <div className=max-w-6xl mx-auto>
        <div className=mb-8>
          ...
          <p className=text-text-muted>Track engagement and performance</p>
        </div>
          ...
          {stats.map((stat, i) => (
            ...
            >
              <div className=flex items-center justify-between mb-3>
                <stat.icon className=w-5 h-5 text-text-subtle />
        ...
        <div className=card text-center py-16>
          <BarChart3 className=w-16 h-16 text-text-subtle mx-auto mb-4 />
          <p className=text-text-muted text-lg mb-2>No data yet</p>
          <p className=text-text-subtle text-sm>Analytics will appear here once your yearbook gets views.</p>
        </div>
      </div>
    </div>
  );
