      ...
      <div className=max-w-6xl mx-auto>
        <div className=flex items-center justify-between mb-8>
          <div>
            ...
            <p className=text-text-muted>Manage your university yearbooks</p>
          </div>
        ...
        <div className=space-y-4>
          {yearbooks.length === 0 ? (
            <div className=card text-center py-12>
              <BookOpen className=w-12 h-12 text-text-subtle mx-auto mb-3 />
              <p className=text-text-muted>No yearbooks yet. Create your first one!</p>
            </div>
          ) : (
            yearbooks.map((yb) => (
              <div key={yb.id} className=card flex items-center justify-between>
                <div>
                  ...
                  <p className=text-text-muted text-sm>{yb.year} · {yb.status}</p>
                </div>
