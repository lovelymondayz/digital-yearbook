...
export default function RegisterPage() {
 ...
 <div className="w-16 h-16 rounded-lg bg-gradient-to-br from-primary to-primary flex items-center justify-center mx-auto mb-4">
 <BookOpen className="w-8 h-8 text-text" />
 </div>
 <h1 className="text-2xl font-bold text-text">Create account</h1>
 <p className="text-text/50 mt-1">Start your yearbook journey</p>
 </div>
