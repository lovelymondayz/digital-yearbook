      ...
      <div className=max-w-3xl mx-auto>
        ...
        >
          ...
          <div className=flex flex-col items-center text-center mb-8>
            <div className=w-32 h-32 rounded-full bg-primary-subtle flex items-center justify-center mb-4 overflow-hidden>
            ...
            {student.graduation_year && (
              <p className=text-text-subtle text-sm mt-1>Class of {student.graduation_year}</p>
            )}
          </div>
          ...
          {student.quote && (
            <div className=bg-surface-alt rounded-md p-6 mb-6 text-center>
              ...
              <p className=text-text italic text-lg>&ldquo;{student.quote}&rdquo;</p>
            </div>
          )}
          ...
          {student.honors_awards && student.honors_awards.length > 0 && (
            <div className=mb-6>
              <h3 className=text-sm font-semibold text-text-subtle uppercase tracking-wide mb-3>
                Honors & Awards
              </h3>
