    ...
    <div className="min-h-screen py-12 px-4">
      <div className="max-w-6xl mx-auto">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          ...
          <p className="text-text/50 mb-8">Welcome back, {user?.full_name}</p>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
            {stats.map((stat, i) => (
              ...
              >
                ...
                <p className="text-text/50 text-sm">{stat.label}</p>
              </motion.div>
            ))}
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <Link to="/admin/yearbooks" className="card group">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-lg bg-primary-subtle flex items-center justify-center group-hover:bg-[primary]/30 transition-colors">
                  <Plus className="w-5 h-5 text-[primary]" />
                </div>
                <div>
                  <p className="font-semibold text-text">Create Yearbook</p>
                  <p className="text-text/50 text-sm">Start a new yearbook</p>
                </div>
              </div>
            </Link>
            <Link to="/admin/students" className="card group">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-text/50 text-sm">Bulk import students</p>
                </div>
              </div>
            </Link>
            <Link to="/admin/analytics" className="card group">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-lg bg-primary-subtle flex items-center justify-center group-hover:bg-[primary]/60 transition-colors">
                  <BarChart3 className="w-5 h-5 text-text/70" />
                </div>
                <div>
                  <p className="font-semibold text-text">View Analytics</p>
                  <p className="text-text/50 text-sm">Track engagement</p>
                </div>
              </div>
            </Link>
          </div>
