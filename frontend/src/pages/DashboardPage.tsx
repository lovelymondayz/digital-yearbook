...
export default function DashboardPage() {
  ...
  const stats = [
    { label: "Yearbooks", value: "0", icon: BookOpen },
    { label: "Students", value: "0", icon: Users },
    { label: "Page Views", value: "0", icon: BarChart3 },
    { label: "Bookmarks", value: "0", icon: Settings },
  ];
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
            {stats.map((stat, i) => (
              <motion.div
                ...
                className="card"
              >
                <div className="w-10 h-10 rounded-md bg-primary-subtle flex items-center justify-center mb-3">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <Link to="/admin/yearbooks" className="card group">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-md bg-primary-subtle flex items-center justify-center group-hover:bg-primary-subtle transition-colors">
